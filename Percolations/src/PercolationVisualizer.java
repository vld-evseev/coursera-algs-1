...
public class PercolationVisualizer {
	...
	private final static String TEST_PATH = "C:\\Users\\Vlad\\Documents\\coursera-algs-1\\Percolations\\percolation-testing\\";
    ...
    public static void main(String[] args) {
        In in = new In(TEST_PATH + "input20.txt");      // input file
